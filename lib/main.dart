...
class _OBDHomeScreenState extends State<OBDHomeScreen> {
  ...
  double _speed = 0.0;
  double _maf = 0.0; // Flujo de aire masivo (g/s)
  double _intakeManifoldPressure =
      0.0; // Presión del colector de admisión (kPa)

  Timer? _commandTimer;
  int _currentCommandIndex = 0;

  // Lista de comandos OBD2 a enviar
              ...
              if (_isConnected)
                Column(
                  children: [
                    ...
                    // Segunda fila: Temperatura y Carga
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                    ...
                    // Tercera fila: Avance de Encendido y MAF
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        // Tarjeta para Avance de Encendido
                        Expanded(
                          child: Card(
                            margin: EdgeInsets.all(10),
                            child: Padding(
                        ...
                        // Tarjeta para Flujo de Aire Masivo (MAF)
                        Expanded(
                          child: Card(
                            margin: EdgeInsets.all(10),
                            child: Padding(
                    ...
                    // Cuarta fila: Presión del Colector de Admisión
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        // Tarjeta para Presión del Colector de Admisión
                        Expanded(
                          child: Card(
                            margin: EdgeInsets.all(10),
                            child: Padding(
